...
using UZeroMedia.SOA.Areas.HelpPage.ModelDescriptions;
...
namespace UZeroMedia.SOA.Areas.HelpPage
{
    ...
    public class MultipleXmlDocumentationProvider : IDocumentationProvider, IModelDocumentationProvider
    {
        ...
        public string GetDocumentation(HttpControllerDescriptor controllerDescriptor)
        {
            ...
            //if (Attribute.IsDefined(controllerDescriptor.ControllerType, typeof(UCoreAuthorizeAttribute)))
            //{
            //    s.Add("<p style=\"color:#E43535\"><i class='glyphicon glyphicon-lock'></i> 需要身份授权</p>");
            //}
        ...
        public virtual string GetDocumentation(HttpActionDescriptor actionDescriptor)
        {
            ...
            // Add message if controller requires authorization
            //if (actionDescriptor.GetCustomAttributes<UCoreAuthorizeAttribute>().Any())
            //{
            //    s.Add("<p style=\"color:#E43535\"><i class='glyphicon glyphicon-lock'></i> 需要身份授权</p>");
            //}
